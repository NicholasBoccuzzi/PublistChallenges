  ...
  */
  ...
  _createClass(MainContent, [{
    ...
    value: function componentDidMount() {
      ...
      console.log(this.token); // curl -X POST -H 'Authorization: Bearer {{your.api.token}}' -H 'Content-type: application/json' -d '{"query": "tech"}' 'https://publist.ai/api/v2/jobs.frontend'

      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('https://publist.ai/api/v2/jobs.frontend', {
        headers: {
...
//# sourceMappingURL=4.4895b7939220e2f9fefc.hot-update.js.map